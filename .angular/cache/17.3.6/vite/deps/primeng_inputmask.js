import {
  InputText,
  InputTextModule
} from "./chunk-ASYHSOUU.js";
import {
  TimesIcon
} from "./chunk-STFDHD47.js";
import {
  NG_VALUE_ACCESSOR
} from "./chunk-YC2WWV2I.js";
import {
  AutoFocus,
  AutoFocusModule
} from "./chunk-VU5BN3FH.js";
import {
  DomHandler,
  PrimeTemplate,
  SharedModule
} from "./chunk-FTVFTWBV.js";
import "./chunk-VG73GF5K.js";
import {
  CommonModule,
  DOCUMENT,
  NgClass,
...
var InputMask = class _InputMask {
  ...
  static ɵfac = function InputMask_Factory(t) {
    return new (t || _InputMask)(ɵɵdirectiveInject(DOCUMENT), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef));
  };
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 3,
    vars: 21,
    consts: [["input", ""], ["pInputText", "", "pAutoFocus", "", 1, "p-inputmask", 3, "focus", "blur", "keydown", "keypress", "input", "paste", "ngStyle", "ngClass", "disabled", "readonly", "autofocus"], [4, "ngIf"], [3, "styleClass", "click", 4, "ngIf"], ["class", "p-inputmask-clear-icon", 3, "click", 4, "ngIf"], [3, "click", "styleClass"], [1, "p-inputmask-clear-icon", 3, "click"], [4, "ngTemplateOutlet"]],
    template: function InputMask_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵproperty("ngStyle", ctx.style)("ngClass", ctx.styleClass)("disabled", ctx.disabled)("readonly", ctx.readonly)("autofocus", ctx.autofocus);
